...
func createMenubarIcon(size: CGSize, outputPath: String) {
...
// Simple SVG path parser for the specific paths in finger_easyshortcut.svg
...
// Generate both sizes
// According to macOS HIG and Bjango guidelines:
// - Menu bar working area is 22pt tall
// - Recommended icon height is ~16pt for circular items
// - 1pt = 1px on non-Retina, 2px on Retina
// Using 10x10pt to match visual size of native menubar icons
createMenubarIcon(size: CGSize(width: 10, height: 10),
                  outputPath: "Assets.xcassets/StatusIcon.imageset/StatusIcon.png")
createMenubarIcon(size: CGSize(width: 20, height: 20),
                  outputPath: "Assets.xcassets/StatusIcon.imageset/StatusIcon@2x.png")

print("\nMenubar icons generated successfully!")
